    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				<a  href = "deac_update_status.php"class = "btn btn-danger btn-outline pull-right" style = "margin-right:12px;" name = "go"><i class = "fa fa-asterisk fa-spin"></i> Deactivate All Voters Account</a>
                                    ...
                                    <tbody>
										...
										?>
											...
											<tr>
												...
												<td><?php echo $row1 ['cohort'];?></td>
												<td><?php echo $row1 ['status'];?></td>
												<td><?php echo $row1 ['account'];?></td>
                                                <td style="text-align:center">
											
                                                <a rel="tooltip"  title="Delete" id="<?php echo $voters_id ?>" href="#delete_admin<?php echo $voters_id; ?>" data-target="#delete_admin" data-toggle="modal"class="btn btn-danger btn-outline"><i class="fa fa-trash-o"></i> Delete</a>	
